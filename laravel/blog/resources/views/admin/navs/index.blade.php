...
@section('content')
    ...
    <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo;導航列管理
    </div>
    <!--面包屑导航 结束-->
    ...
    <form action="#" method="post">
        <div class="result_wrap">
            ...
            <div class="result_content">
                ...
                <a href="{{url('admin/navs/create')}}"><i class="fa fa-plus"></i>新增導航列</a>
                <a href="{{url('admin/navs')}}"><i class="fa fa-recycle"></i>全部導航列</a>
                </div>
            </div>
            <!--快捷导航 结束-->
        </div>
