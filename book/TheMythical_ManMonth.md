...
- 程式
    ...
    - 3倍時間 => 軟體產品
        - 9倍時間 => 軟體系統產品
- 軟體工程
    - 如何開發並設計出一組程式，使之成為一個[系統]
    - 如何開發並設計出一組程式或一個系統，使之成為一個穩健、測試完成、文件齊全、可維護的[產品]
    - 如何維持在智能上掌握著大型專案裡的[複雜性]
...
## 第19章《人月神話》20年
- 為了達到軟體一致性的體驗，英雄式的管理是需要的
- 定義使用者群
    - Who they are
    - What they need 需要什麼 原始需求
    - What they think they need
    - What they want 想要什麼
    - 產品功能可以滿足 need 就會成為 want
- 使用者屬性是一種分佈 distribution，由許多值 value 組成，每個值都有頻率 frequency
    - gIBIS(待查)
- WIMP
    - Windows
    - Icon
